    ...
    <div className="min-h-screen bg-gray-100 flex flex-col">
      ...
      <div className="py-10 px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-10">
          <StatCard title="Total Candidatas" value="87" icon={Users} color="text-blue-600" />
          <StatCard title="Votantes Registrados" value="512" icon={ListChecks} color="text-green-600" />
          <StatCard title="Instituciones" value="14" icon={Building} color="text-orange-500" />
          <StatCard title="Categorías" value="20" icon={Layers} color="text-purple-600" />
        </div>
...
function MainCard({ icon: Icon, title, text, color }) {
  return (
    <div className="bg-white p-8 shadow-lg rounded-xl flex flex-col items-center text-center hover:scale-[1.02] transition cursor-pointer">
